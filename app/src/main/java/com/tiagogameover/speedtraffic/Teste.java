...
import com.tiagogameover.speedtraffic.teste.GetSpeedTestHostsHandler;
import com.tiagogameover.speedtraffic.teste.HttpDownloadTest;
import com.tiagogameover.speedtraffic.teste.HttpUploadTest;
import com.tiagogameover.speedtraffic.teste.PingTest;
...
public class Teste extends AppCompatActivity {
    ...
    public static String ping="ping",down="down",uplo="uplo";
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                startButton.setText("Testando a velocidade da internet...");
                            }
                        });
                            ...
                            if (timeCount <= 0) {
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        startButton.setText("Reiniciar teste ");
                                    }
                                });
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                ping= pingTextView.getText().toString();
                                down= downloadTextView.getText().toString();
                                uplo= uploadTextView.getText().toString();
                                DatabaseHandler db = new DatabaseHandler(Teste.this);
                                db.addUsers(new ListDataModel("Ping: "+ping,"Download: "+down,"Upload: "+
                                        uplo,"Data:"+"  " + stDia + "/" + stMes + "/" + stAno));
                                startButton.setText("Reiniciar Teste");
